...
exports.RenderedBlock = exports.renderBlockComment = exports.Compiler = void 0;
...
function renderBlockComment(text) {
    let start = 76 / 2 + Math.floor(text.length / 2);
    return `/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/\n`
        + `/*${text.padStart(start, " ").padEnd(76, " ")}*/\n`
        + `/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/\n`;
}
exports.renderBlockComment = renderBlockComment;
class RenderedBlock {
    constructor(qname) {
        this.deps = [];
...
exports.RenderedBlock = RenderedBlock;
