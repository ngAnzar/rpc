...
function createEntityCode(comp, ent) {
    ...
    res += `    public static readonly PROVIDE: FactoryProvider = { provide: ${schema_1.Entity.qname(ent).name}, useFactory: ${schema_1.Entity.qname(ent).name}.factory, deps: [Client] }\n`;
