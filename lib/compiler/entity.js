...
function createEntityCode(comp, ent) {
    ...
    res += `    public static readonly PROVIDER: FactoryProvider = { provide: ${schema_1.Entity.qname(ent).name}.CLASS, useFactory: ${schema_1.Entity.qname(ent).name}.factory, deps: [Client__] }\n`;
